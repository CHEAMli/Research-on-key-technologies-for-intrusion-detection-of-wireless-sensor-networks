"""
实验: STL+PCA预处理 + CNN-LSTM模型 (IoT数据集)
...
# 实验配置
EXPERIMENT_NAME = "IoT_STL_PCA_CNN_LSTM"
NUM_RUNS = 5
EPOCHS = 1
BATCH_SIZE = 128
...
output_file = f"{RESULTS_DIR}/iot_stl_pca_cnn_lstm_{timestamp}.csv"
